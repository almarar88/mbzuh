...
| **تحكم مباشر (2.1)** | مفتاح الحظر أعلى الرئيسية، «إيقاف مؤقت» (١٥/٣٠/٦٠ دقيقة أو حتى بكرة) من الرئيسية أو من الإشعار، «إعفاء اليوم» لكل تطبيق، أزرار −/+ للحد، بطاقة «كيف يشتغل»، وأسئلة شائعة في الإعدادات. |
| **إلغاء طارئ للوضع الصارم** | انتظار ٣٠ ثانية وكتابة «أنا أتراجع عن وعدي». |
